...
PSOC_AGING_COEFFICIENT: float = 1.5e-3      # tune during calibration
...
def temperature_acceleration_factor(
    ...
    TODO (USER): implement.
    """
    raise NotImplementedError("USER: Arrhenius factor")
...
def psoc_aging_multiplier(
    ...
    TODO (USER): implement.
    """
    raise NotImplementedError("USER: PSoC penalty")
...
def update_health(
    ...
    """
    raise NotImplementedError("USER: aging dynamics")
...
def coulomb_counting_step(
    ...
    """
    raise NotImplementedError("USER: coulomb counting")
...
def shepherd_discharge_voltage(
    ...
    TODO (USER): implement.
    """
    raise NotImplementedError("USER: Shepherd discharge model")
...
def float_voltage(
    ...
    TODO (USER): implement.
    """
    raise NotImplementedError("USER: float voltage")
...
def charge_acceptance_current(
    ...
    TODO (USER): implement.
    """
    raise NotImplementedError("USER: charge acceptance")
